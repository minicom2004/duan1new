...
<body>
    <div class="main">
        ...
        <div class="form-account">
            ...
            <form action="?url=dangky" method="post" class="form-account_body" novalidate>
                ...
                <div class="form-account_content">
                    ...
                    <div class="form-account_error">
                        <div class="form-account_error-emty"></div>
                        <!-- Lỗi nhập vào form-account_error-text-->
                        <div class="form-account_error-text"><?php echo $errors["nguoidung_matkhau"] ?? '' ?></div>
                    </div>
                </div>
                <div class="form-account_content">
                    <div class="form-account_input">
                        <label for="">Nhập Lại Mật Khẩu</label>
                        <input type="password" name="repassword" placeholder="Nhập lại mật khẩu" value="<?php echo $repassword ?? ''?>">
                    </div>
                    <div class="form-account_error">
                        <div class="form-account_error-emty"></div>
                        <!-- Lỗi nhập vào form-account_error-text-->
                        <div class="form-account_error-text"><?php echo $errors["nguoidung_nhaplaimk"] ?? '' ?></div>
                    </div>
                </div>
                <div class="form-account_features">
                    <a href="#" class="form-account_feature"></a>
                    <a href="?url=dangnhap" class="form-account_feature">Bạn đã có tài khoản? Đăng nhập</a>
                </div>
