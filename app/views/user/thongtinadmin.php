...
<body>
    <div class="main">
      <form action="?url=thongtinadmin" method="post" enctype="multipart/form-data" class="row g-3 needs-validation form-info" novalidate>
        ...
        <h1 class="form-info_heading">Thông Tin ADMIN</h1>
        <div class="col-md-5">
